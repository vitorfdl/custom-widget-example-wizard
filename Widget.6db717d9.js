...
function F() {
  i.some(function (t) {
    if (t.__P) try {
      ...
      return t.__H.__h = [], _preact.options.__e(r, t.__v), !0;
    }
  }), i = [];
}
...
},{"preact":"../node_modules/preact/dist/preact.module.js"}],"../node_modules/@tago/custom-widget/dist/custom-widget.js":[function(require,module,exports) {
...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../node_modules/@tago/custom-widget/dist/custom-widget.css":[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"Widget.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"Step1.jsx":[function(require,module,exports) {
"use strict";
...
},{"preact":"../node_modules/preact/dist/preact.module.js"}],"Step2.jsx":[function(require,module,exports) {
"use strict";
...
function Step2(props) {
  ...
  return (0, _preact.h)("div", {
    className: "step-container"
  }, (0, _preact.h)("h3", null, "Step 2"), (0, _preact.h)("br", null), (0, _preact.h)("div", {
    class: "form-group"
  }, (0, _preact.h)("label", {
    for: "var3"
  }, "var3"), (0, _preact.h)("input", {
    id: "var3",
    value: variables && variables.var3 ? variables.var3 : "",
    onChange: function onChange(e) {
      return onChangeVariable('var3', e.target.value);
    }
  })), (0, _preact.h)("div", {
    class: "form-group"
  }, (0, _preact.h)("label", {
    for: "var4"
  }, "var4"), (0, _preact.h)("input", {
    id: "var4",
    value: variables && variables.var4 ? variables.var4 : "",
    onChange: function onChange(e) {
      return onChangeVariable('var4', e.target.value);
    }
  })));
}
},{"preact":"../node_modules/preact/dist/preact.module.js"}],"Step3.jsx":[function(require,module,exports) {
"use strict";
...
function Step2(props) {
  ...
  return (0, _preact.h)("div", {
    className: "step-container"
  }, (0, _preact.h)("h3", null, "Step 3"), (0, _preact.h)("br", null), (0, _preact.h)("div", {
    class: "form-group"
  }, (0, _preact.h)("label", {
    for: "var5"
  }, "var5"), (0, _preact.h)("input", {
    id: "var5",
    value: variables && variables.var5 ? variables.var5 : "",
    onChange: function onChange(e) {
      return onChangeVariable('var5', e.target.value);
    }
  })), (0, _preact.h)("div", {
    class: "form-group"
  }, (0, _preact.h)("label", {
    for: "var6"
  }, "var6"), (0, _preact.h)("input", {
    id: "var6",
    value: variables && variables.var6 ? variables.var6 : "",
    onChange: function onChange(e) {
      return onChangeVariable('var6', e.target.value);
    }
  })));
}
},{"preact":"../node_modules/preact/dist/preact.module.js"}],"Widget.jsx":[function(require,module,exports) {
"use strict";
...
require("@tago/custom-widget");

require("@tago/custom-widget/dist/custom-widget.css");
...
function Widget() {
  ...
  var steps = [_Step.default, _Step2.default, _Step3.default];
  ...
  var onChangeVariable = function onChangeVariable(variableName, value) {
    setVariables(_objectSpread({}, variables, _defineProperty({}, variableName, value)));
  };
  ...
  (0, _hooks.useEffect)(function () {
    ...
    window.TagoIO.onRealtime(function (data) {
      ...
      var realtime = {}; // var2 is a dropdown variable, the selected data is saved in var2val
      ...
      if (data && data.result.length) {
        data.result.forEach(function (el) {
          ...
          } else if (realtime[el.variable] == undefined || realtime[el.variable] == "") {
  ...
  var sendData = function sendData() {
    ...
    window.TagoIO.sendData(arr, function (response) {
      if (response.status) {
  ...
  }, "New form")) : (0, _preact.h)("div", null, (0, _preact.h)(ActualStep, {
    variables: variables,
    onChangeVariable: onChangeVariable
  }), (0, _preact.h)("div", {
    className: "buttons"
  }, activeStep > 0 && (0, _preact.h)("button", {
    onClick: previousStep
  }, "Previous"), activeStep < steps.length - 1 ? (0, _preact.h)("button", {
    onClick: nextStep
  }, "Next") : (0, _preact.h)("button", {
    onClick: sendData
  }, "Submit")), (0, _preact.h)("div", {
    style: "text-align:center;margin-top: 15px;"
  }, steps.map(function (el, index) {
...
(0, _preact.render)((0, _preact.h)(Widget, null), document.body);
},{"preact":"../node_modules/preact/dist/preact.module.js","preact/hooks":"../node_modules/preact/hooks/dist/hooks.module.js","@tago/custom-widget":"../node_modules/@tago/custom-widget/dist/custom-widget.js","@tago/custom-widget/dist/custom-widget.css":"../node_modules/@tago/custom-widget/dist/custom-widget.css","./Widget.css":"Widget.css","./Step1":"Step1.jsx","./Step2":"Step2.jsx","./Step3":"Step3.jsx"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","Widget.jsx"], null)
//# sourceMappingURL=/Widget.6db717d9.js.map